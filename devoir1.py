...
for article in articles:
	...
	media = article[0]
	section = article[1]
	mots = article[2][24:].strip(" mots")
	page = article[3].strip("p. ")
	print("Le journal " + media + ", dans sa section "+section + ", a publié un article de " +mots + " mots à la page "+page)
	if media == "Le Soleil":
		nbsoleil+=1
	if media == "Le Devoir":
		nbdevoir+=1
	...
	if media == "La Tribune":
		nbtribun+=1
	if media == "La Voix de l'Est":
		nbvoixde+=1


print("Le journal Le Soleil a publié " +str(nbsoleil)+ " articles.")
print("Le journal Le Devoir a publié " +str(nbdevoir)+ " articles.")
print("Le journal La Presse a publié " +str(nbpresse)+ " articles.")
print("Le journal Le Nouvelliste a publié " +str(nbnouvel)+ " articles.")
print("Le journal La Tribune a publié " +str(nbtribun)+ " articles.")
print("Le journal La Voix de l'Est a publié " +str(nbvoixde)+ " articles.")
